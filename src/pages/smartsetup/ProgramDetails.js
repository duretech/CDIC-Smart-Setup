...
const ProgramDetails = () => {
    ...
    useEffect(()=>{
        setLanguagesOptions(countries.languagesList && countries.languagesList.map(({ locale, name }) => ({ value: locale, label: name })));
    },[])
                                                ...
                                                <select 
                                                    ...
                                                    >
                                                        ...
                                                        (countries.countryList.length > 0)
                                                            ? countries.countryList.map((country, idx) => {
                ...
                <Modal.Header closeButton>
                    ...
                    <Modal.Body>
                        <Container>
                            <Row>
                            {
                                appicons.length > 0 && appicons.map(image => {
                                    return <Col xs={6} md={2} className="mb-3"><Image src={images[image].default} rounded thumbnail onClick={() => handleImgeSelection(image)} /></Col>
                                })
                            }
                            </Row>
                        </Container>
